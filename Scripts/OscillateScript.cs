...
// Script to oscillate planet 3 (Mars).

public class OscillateScript : MonoBehaviour
{
    private Vector3 pointA = new Vector3(8.83f, 7.5f, -4.0f);   //Setting two point coordinates between which it will oscillate.
    private Vector3 pointB = new Vector3(8.83f, 7.5f, 4.0f);
